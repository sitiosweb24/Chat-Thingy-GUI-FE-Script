...
local function BZMG_script() -- loaderxploits.loader 
...
coroutine.wrap(BZMG_script)()
local function UVIQNE_script() -- loaderxploits.notify 
	local script = Instance.new('LocalScript', loaderxploits)
...
coroutine.wrap(UVIQNE_script)()
-- chatthingyguiOLDCHAT.NewChatScript is disabled.
local function ODUIYZ_script() -- mainmighty.drag 
...
coroutine.wrap(ODUIYZ_script)()
local function KKBKPVR_script() -- ksystemmightyflea.drag 
...
coroutine.wrap(KKBKPVR_script)()
local function OLDWBY_script() -- ksystemmightyflea.notify 
	local script = Instance.new('LocalScript', ksystemmightyflea)
...
coroutine.wrap(OLDWBY_script)()
local function SDWENW_script() -- ksystemmightyflea.LocalScript 
	local script = Instance.new('LocalScript', ksystemmightyflea)
...
coroutine.wrap(SDWENW_script)()
local function UYNGHA_script() -- chatthingyguiOLDCHAT.OldChatScript 
